...
\begin{frame}{Differential Dynamic Logic}{Motivating Example}
  ...
  \begin{block}{ECTS Safety Verification}
    ...
    \begin{enumerate}
      \item Deduce precondition $\psi$, using the calculus.
...
\begin{frame}{Differential Dynamic Logic}{Proof Calculus}
  ...
  \end{block}
  F rules are based on Tableuax methods for FOL.
\end{frame}
...
\begin{frame}{Differential Dynamic Logic}{Proof Calculus}
  ...
  \end{figure}
  Logical variable $X$ only occurs in $\Phi_i \vdash \Psi_i$
  \end{block}
\end{frame}
...
\begin{frame}{Differential Dynamic Logic}{Proof Calculus Application}
  \begin{block}{European Train Control System (ETCS) Safety}
    Having discovered the precondition, we prove safety
    \begin{figure}
...
\begin{frame}{Differential Dynamic Logic}{Proof Calculus Application}
  \begin{block}{European Train Control System (ETCS) Safety}
    \begin{figure}
      \includegraphics[scale=0.4]{ects-safety-2}
    \end{figure}
  \end{block}
\end{frame}
